...
const Nav = () => {
  return (
    <>
    <div className='bg-transparent flex justify-between px-[98px] py-[15px]'>
    <div className="flex justify-center gap-x-[24px] items-center">
        <img src={TvLogo} className='cursor-pointer' alt=""/>
        <p className='text-[24px] font-[700] text-white cursor-pointer'>MovieBox</p>
      </div>
    <div className="relative flex justify-center gap-x-[24px] items-center">
        <input type="text" id='inputText' className='w-[525px] py-[6px] px-[10px] bg-transparent rounded-[6px] border-[#D1D5DB] border-[2px] '>
        </input>
        <svg className='absolute right-[2%] ' xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
  <path d="M14 14L10 10M11.3333 6.66667C11.3333 9.244 9.244 11.3333 6.66667 11.3333C4.08934 11.3333 2 9.244 2 6.66667C2 4.08934 4.08934 2 6.66667 2C9.244 2 11.3333 4.08934 11.3333 6.66667Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      ...
      <div className="flex justify-center gap-x-[24px] items-center text-white">
        <span className='text-[16px] font-[700]'>Sign in</span>
        <svg className='bg-[#BE123C] w-[36px] h-[36px] rounded-full' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
